...
<body class="grid-container">
    ...
    <section class="infor">
        <div class="seccion contenedor"> 
            ...
            <h2 class="fw-300 centar-texto">Cesta de chocolate y globos </h2>
        ...
        <div> 
            ...
            <h4> 
                ...
                Caja sorpresa la cual puede llevar, gallatas, chocolates, boleros, de
                 <b><i>tu preferencia</b></i> 
                ademas un mensaje en la tapa de la caja, y al momento de abrir la caja una foto,
                 mas decoracion. 
            </h4> 
            </article>
