            ...
            <article class="segund">
                <div>
                    ...
                    <h2 class="fw-300 centrar-texto">
                        ...
                        llena el formulario de tu direccion de domicilio
                    ...
                    <form method="post">
                             ...
                             <label for="codigo">Ingrese el codigo postal</label>

                                <input type="text" name="codigo" id="codigo" placeholder="ingrese el codigo postal">

                             <label for="municipio">Ingrese el municipio</label>

                                <input type="text" name="municipio" id="municipio" placeholder="ingrese el municipio">

                             <input type="submit" class="boton boton-morado" name="ENVIAR">

                    </form>
                    <?php
                         include("./tabla/domicilio.php"); 
                    ?>

                </div>
            </article>
            <a class="boton boton-morado d-block" href="mostrar.php">Ver la informacion ingresada</a>
        </main>
    </section>
