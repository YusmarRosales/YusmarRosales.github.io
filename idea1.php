...
<body class="grid-container">
    ...
    <aside class="aside"> 
        ...
        <img src="img/chuche.jpeg" alt=" caja sorpresa">  
    ...
    <section class="infor"> 
        ...
        <h4 class="fw-300 centar-texto">Caja de chucherias</h4>  
        <div> 
            <article class="prim"> 
            <h4>  
                DESCRIPCIÓN:   
                caja de chucheria la cual puede llevar, gallatas, chocolates, boleros, de <b><i>tu preferencia</b></i>  
