            ...
            <article class="segund">
                <div>
                    ...
                    <h2 class="fw-300 centrar-texto">
                        ...
                        llena el formulario de tu arreglo
                    ...
                    <form method="post">
                            ...
                            <label for="tipo">Ingrese el tipo de arreglo</label>

                            <input type="text" name="tipo" id="tipo" placeholder="ingrese el tipo de arreglo">

                            <label for="chucherias">Ingrese las chucherias</label>

                            <input type="text" name="chucherias" id="chucherias" placeholder="ingrese las chucherias">

                            <label for="globos">Ingrese la clase de globo</label>

                            <input type="text" name="globos" id="globos" placeholder="ingrese la clase de globos">

                            <label for="flores">Ingrese la clase de flores</label>

                            <input type="text" name="flores" id="flores" placeholder="ingrese la clase de flores">
                    ...
                    <?php
                         include("./tabla/arreglo.php"); 
                    ?>
                </div>
            </article>
            <a class="boton boton-morado d-block" href="datos.php">Ingresa tus datos</a>
        </main>
        <!--fin de contactos-->
    </section>
